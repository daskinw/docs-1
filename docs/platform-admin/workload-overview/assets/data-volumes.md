...
![data-volumes-architecture](../../workloads/assets/img/data-volumes-arch.svg)

#### Prerequisites

To create a data volume, there must be a [project](../../org/projects.md) with a PVC in its namespace.
...
Data volumes are used when [submitting workloads](../overviews/managing-workloads.md#adding-new-workload). Any user, application or SSO group with a [role](broken-reference) that has permissions to create workloads can also use data volumes.
